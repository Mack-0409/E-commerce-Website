...
const AddPage = () => {
    ...
    // after submit reset the form to it initial state
    const resetForm = () => {
        setName("");
        setDescription("");
        setPrice("");
                    ...
                    <form onSubmit={handleSubmit} className={classes.formContainer(theme)}>
                            ...
                            <div className=" flex item-center gap-4">
                                ...
                                <div className=" flex-1">
                                    ...
                                    <p className={classes.helperText}>
                                        Recommented: JPG/PNG. Max size: 5MB. 
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder='e.g, Classic Sliver Urban'
                        ...
                        <div>
                            ...
                            <textarea value={description} onChange={(e) => setDescription(e.target.value)}
                                rows={4} placeholder='Short Descripton about the watch' className={`${inputClass} resize-none`} required disabled={loading}    
                            ></textarea>
                        </div>
