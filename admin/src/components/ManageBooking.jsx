...
import { Calendar, ChevronDown, CreditCard, MessageSquare, Phone, Search, Trash2, User, Watch, MapPin } from 'lucide-react';
                ...
                <div className={bookingStyles.headerContainer}>
                    ...
                    <div>
                        ...
                        <p className={bookingStyles.headerSubtitle}>
                            View and manage customer booking
                        </p>
                    </div>
                </div>
                ...
                <div className={bookingStyles.bookingsContainer}>
                    ...
                    {filtered.length === 0 ? (
                        <div className={bookingStyles.noBookingsContainer}>
                            ...
                            <p className={bookingStyles.noBookingsText}>No booking found...</p>
                        </div>
                    ): (
                        filtered.map((b) => {
                            const isCancelled = 
